...
export class PriorityQueue<T> {
  ...
  private bubbleDown(startIndex: number): void {
    ...
    while (true) {
      ...
      if (leftIndex < this.heap.length && this.comesBefore(this.heap[leftIndex], this.heap[bestIndex])) {
        bestIndex = leftIndex
      }

      if (rightIndex < this.heap.length && this.comesBefore(this.heap[rightIndex], this.heap[bestIndex])) {
